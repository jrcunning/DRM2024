...
ggsave(filename = "figures/FigS7n.png", width = 120, height = 100, units = "mm")
...
```{r}
# FINAL FIGURE for proxy validation
cowplot::plot_grid(p1, p2, p3, nrow = 3, align = "h", labels = "AUTO")

ggsave(filename = "figures/FigS8n.png", width = 90, height = 240, units = "mm")
```
