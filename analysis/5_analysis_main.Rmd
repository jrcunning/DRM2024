...
(decomp <- ggplot(out, aes(x = Species, y = value, fill = name)) +
  ...
  scale_fill_manual(name = "Model-estimated drivers", 
                      labels = c("∆ pop. density", "# symbiont genera", "unexplained"),
...
#   predicted_degC = coef(ols_model_adjusted)["(Intercept)"] + ols_slope_estimate * estimate_seq
# )
pred_est <- predict(
  ols_model_adjusted,
...
#   ngen = ngen_seq,
#   predicted_degC = coef(ols_model_adjusted)["(Intercept)"] + ols_slope_ngen * (ngen_seq - 1)
# )
