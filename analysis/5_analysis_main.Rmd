...
CAN WE GET BOOTSTRAPPED INTERVALS FOR SPECIES ED50S AND ED90-ED10S? ADD THESE TO FIGURE 3? AND USE AS WEIGHTS IN THE NGEN ANALYSIS, FIGS3?
```{r TRYBOOT}
ed50s <- ED(m3, 0.5, type = "absolute", interval = "delta", display = FALSE) %>%
  as_tibble()

ED(m3, c(0.1, 0.9), type = "absolute", interval = "delta")

compParm(m3, strVal = "ED50", operator = "-")
