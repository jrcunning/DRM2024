...
dhw.bleach.plot <- ggplot(as.tibble(dhw.res2), aes(x = dhw, y = prob, group = year)) +
  ...
  geom_text(data = dhw_ranges,
           ...
           hjust = c(0,0,1,0), nudge_y = c(0,0,0,0)) +
...
(dhw.bleach.plot +
  annotate("text", x = 11.1, y = 0.04, hjust = 0, size = 3, 
           label = paste0("+", signif(ed50conf$ed50[[6]], 2), " DHW\n", 
                          "= +", signif(finaldegC23$degC, 2), " °C")) +
  annotate("text", x = 18.4, y = 0.04, hjust = 0, size = 3, fontface = "italic",
...
ggsave(filename = "figures/FigS4new6.png", plot = dhw.sp.bleach.plot, width = 140, height = 140, units = "mm")
