...
# Plot ED90-ED10 diffs vs. ED50 with errorbars
oldfig3 <- ggplot(eds, aes(x = Estimate, y = Diff)) + 
  geom_point(aes(size = ngen^4, alpha = 0.7)) +
...
ggsave(filename = "figures/Fig3.png", plot = figS3, width = 90, height = 90, units = "mm")
```
...
ggplot(sp.degC, aes(x = Species, y = degC)) +
  geom_point() +
  geom_errorbar(aes(ymin = degC.lower, ymax = degC.upper))
...
ggsave(filename = "figures/Fig5agar.png", plot = fig5,
