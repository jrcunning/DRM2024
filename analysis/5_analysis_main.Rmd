...
# --- verify the exact bins you asked for ---
...
# # Exclude 2024 from species-level analysis
# allgno24 <- filter(allg, year != "2024")
# 
...
#   family = "binomial", data = allgno24, verbose = FALSE,
...
#   #(year == "2024" & Week2 == "(38,40]" & dhw <= 11.7 & dhw > 0.16) 
# )
# 
# 
# # Plot
...
# # sp.boot.out <- bootMer(dhw.sp.mod, FUN = sp.ed50s.fun, nsim = 100, seed = 123, re.form = NULL,
