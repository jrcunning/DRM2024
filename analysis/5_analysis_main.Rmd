...
set.seed(1)
boot.outnull <- bootMer(dhw.mod, FUN = ed50s.fun_fast, nsim = 100, re.form = NULL,
...
dhw.bleach.plot <- ggplot(as.tibble(dhw.res2), aes(x = dhw, y = prob, group = year)) +
  ...
  #geom_line(data = dhw.res3, linetype = 2, linewidth = 0.2) +
  ...
  geom_segment(data = slice(ed50conf, 1:3),
              aes(x = ed50, xend = ed50, y = 0.492, yend = -0.025), lty = 1, lwd = 0.1) +
...
(dhw.bleach.plot +
  annotate("text", x = 14.7, y = 0.082, hjust = 0, size = 3, 
...
dhw.sp.res2 <- subset(dhw.sp.res,
  (year == "2014" & Week2 == "(34,36]" & dhw <= 8.11 & dhw > 0.48) |
...
ggsave(filename = "figures/FigS4new.png", plot = dhw.sp.bleach.plot, width = 140, height = 140, units = "mm")
