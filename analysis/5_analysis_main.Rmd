...
ggsave(filename = "figures/Fig3new.png", width = 200, height = 100, units = "mm")
...
densdiffs <- read_csv("data/processed/densdiffs_smoth3.csv")
...
ggsave(filename = "figures/Fig4_smoth3.png", width = 300, height = 95, units = "mm")
...
ggsave(filename = "figures/FigS7new.png", plot = sizeplot,
...
# ============================================================
#
#    USE UNCERTAINTY IN PREDICTOR (HELLINGER DIST) FOR THIS PART OF THE ANALYSIS?
#
...
# Fit the model, with intercept zero at estimate = 0 and ngen = 1
#  Weight observations using the standard error of the degC response
mod2 <- lm(degC_w ~ 0 + estimate + ngen_centered, data = sym_shifts, weights = 1/degC_w.se^2)
summary(mod2)
