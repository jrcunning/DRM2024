...
# Get point estimates for ED50s and ∆ED50s
sp.bleach50.24 <- sp.ed50s.fun.24(dhw.sp.mod.24.depth)
...
# sp.boot.out.24 <- bootMer(dhw.sp.mod.24.depth, FUN = sp.ed50s.fun.24, nsim = 80, seed = 123, re.form = NULL,
...
sp.degC.w[which(sp.degC.w$Species == "PDIV"), "degC_w.se"] <- 0.0505
