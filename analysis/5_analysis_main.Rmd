...
load("data/processed/2014new.RData")
load("data/processed/2015new.RData")
load("data/processed/2023new.RData")
...
# boot.out <- bootMer(dhw.mod, FUN = ed50s.fun, nsim = 1000, seed = 123, re.form = NULL,
