...
ggsave(filename = "figures/FigS1new.png", plot = surveyplot,
...
rasterplot
ggsave(filename = "figures/Fig1new.png", plot = rasterplot, width = 90, height = 90, units = "mm")
```
...
# Save as Figure2
ggsave(filename = "figures/Fig2new.png", plot = drc.res.ridges,
...
eds <- imap_dfr(
  ...
  mutate(
    ...
    Estimate_ED10_trunc = pmin(ED10_raw, 21),
    ...
    Range_cens = if_else(reach, ED10_raw - Estimate_ED90, 21 - Estimate_ED90),
...
ggsave(filename = "figures/FigS3new.png", plot = figs3, width = 100, height = 100, units = "mm")
```
...
# set.seed(1)
# boot.outnull <- bootMer(dhw.mod24, FUN = ed50s.fun_fast, nsim = 60, re.form = NULL,
...
# 0.98°C [95% C.I. = 0.830-1.13°C]
finaldegC24 <- degC %>% 
  filter(year == 2024) %>%
  dplyr::select(degC, degC.lower, degC.upper)
# 1.60°C [95% C.I. = 1.35-1.85°C]
