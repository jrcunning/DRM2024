...
fig3 <- ggplot(eds, aes(x = ngen, y = Diff_trunc)) +
...
ggsave(filename = "figures/Fig3.png", plot = fig3, width = 100, height = 100, units = "mm")
```
...
fig4alt <- cowplot::plot_grid(fig4, spfig, nrow = 1, rel_widths = c(0.6, 0.4), align = "hv", labels = "AUTO")
fig4alt
ggsave(filename = "figures/Fig4alt.png", width = 200, height = 110, units = "mm")
...
ggsave(filename = "figures/Fig5alt.png", width = 300, height = 95, units = "mm")
...
ggsave(filename = "figures/FigSX.png", width = 300, height = 105, units = "mm")
```
