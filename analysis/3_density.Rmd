...
```{r}
mod6 <- glmer(n ~ Species * year + (1|Species:Subregion), data = dens, family = "poisson",
              verbose = TRUE, nAGQ=0, control=glmerControl(optimizer = "nloptwrap")) 

diffs2 <- rbind(pairs(emmeans(mod6, specs = c("Species", "year")), by = "Species", level = 0.95))

saveRDS(diffs2, file = "data/processed/dens20142023updated.rds")
```
