...
dhw <- read_csv("data/processed/2014_dhw_calc_processed.csv") %>%
  mutate(across(where(is.character), as_factor)) %>%
  #rename(Date = date) %>%
...
dhw <- read_csv("data/processed/2015_dhw_calc_processed.csv") %>%
  mutate(across(where(is.character), as_factor)) %>%
  #rename(Date = date) %>%
  dplyr::select(Site, Date, dhw)
...
dhw <- read_csv("data/processed/2023_dhw_calc_processed.csv") %>%
  mutate(across(where(is.character), as_factor)) %>%
  #rename(Date = date) %>%
  dplyr::select(Site, Date, dhw)
...
dhw <- read_csv("data/processed/2024_dhw_calc_processed.csv") %>%
  mutate(across(where(is.character), as_factor)) %>%
  #rename(Date = date) %>%
  dplyr::select(Site, Date, dhw)
