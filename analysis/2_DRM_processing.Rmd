...
dhw <- read_csv("data/processed/2014_dhw_processed_new.csv") %>%
  mutate(across(where(is.character), as_factor)) %>%
  #rename(Date = date) %>%
...
dhw <- read_csv("data/processed/2015_dhw_processed_new.csv") %>%
  mutate(across(where(is.character), as_factor)) %>%
  #rename(Date = date) %>%
  dplyr::select(Site, Date, dhw)
...
dhw <- read_csv("data/processed/2023_dhw_processed_new.csv") %>%
  mutate(across(where(is.character), as_factor)) %>%
  #rename(Date = date) %>%
  dplyr::select(Site, Date, dhw)
...
dhw <- read_csv("data/processed/2024_dhw_processed_new.csv") %>%
  mutate(across(where(is.character), as_factor)) %>%
  #rename(Date = date) %>%
  dplyr::select(Site, Date, dhw)
