...
# 2023 Bleaching variability across and within species
...
dhw.bleach.plot +
  geom_errorbar(data = slice(ed50conf, 1:3), 
                aes(x = ed50, y = 0.5, xmin = ed50-se, xmax = ed50+se), width = 0.03)
...
# Compare change in heat tolerance to change in density, 2014-2023

```{r bleachthresh_vs_density}
#densres <- readRDS("output/density.rds")
diffs <- readRDS("output/dens20142023.rds")
